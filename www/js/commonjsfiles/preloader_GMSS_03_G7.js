...
Game.preloader_GMSS_03_G7.prototype = {
        preload: function () { 
                ...
                this.load.atlas('bulb', 'assets/commonAssets/bulb.png', null, GMSS_03_G7_JSON.bulbBtnJson);

                this.load.atlas('backbtn', 'assets/commonAssets/backbtn.png', null, GMSS_03_G7_JSON.backbtnJson);
                this.load.atlas('CommonSpeakerBtn', 'assets/commonAssets/speaker.png', null, GMSS_03_G7_JSON.speakerJson);
                this.load.atlas('starAnim', 'assets/commonAssets/starAnim.png', null, GMSS_03_G7_JSON.starAnimJson);
                this.load.atlas('replay', 'assets/commonAssets/reply.png', null, GMSS_03_G7_JSON.replyJson);
                this.load.image('navBar', 'assets/commonAssets/navBar.png');
                this.load.image('timebg', 'assets/commonAssets/timebg.png');
                this.load.image('hand', 'assets/commonAssets/hand.png');

                this.load.atlas('CommonHomeBtn', 'assets/commonAssets/homeBtn.png', null, GMSS_03_G7_JSON.homebtnJson);
                this.load.atlas('CommonNextBtn', 'assets/commonAssets/nextBtn.png', null, GMSS_03_G7_JSON.nextbtnJson);

                //game assets

                this.load.image('BG1', 'assets/gradeAssets/GMSS-03-G7/bg.png');

               // this.load.atlas('Box2', 'assets/gradeAssets/GMSS-03-G7/box 2.png', null, GMSS_03_G7_JSON.Box2);
                this.load.atlas('Box2', 'assets/gradeAssets/GMSS-03-G7/box_1.png', null, GMSS_03_G7_JSON.Box1);

                this.load.image('Box1', 'assets/gradeAssets/GMSS-03-G7/box.png');

                this.load.atlas('TickBtn', 'assets/gradeAssets/GMSS-03-G7/TickBtn.png', null, GMSS_03_G7_JSON.tickJson);
